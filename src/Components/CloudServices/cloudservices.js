...
import "../CloudServices/cloudservices.css";
...
const cloudservices = () => {
  return (
    <>
      <section id="cloud" className="cloud-section">
        <div className="cloud-poster">
          ...
          <p className="cloud-poster-para">
            ...
            leveraging the power of the cloud, we can achieve greater
            efficiency, drive innovation, and adapt to evolving market dynamics.
            With Proso AI, we empower you to unlock the full potential of the
            cloud, fostering delightful customer experiences, fostering
            collaboration, and optimizing your value chain for sustainable
            profit and growth.
          </p>
        </div>
          ...
          <div className="container cloud-container">
            <div className="left-div-cloud">
              ...
              <p className="left-head-para-cloud">
                ...
                solutions across the IT supply chain. As your sole partner in
                this endeavor, Direccion consolidates all facets, empowering you
                to confidently accelerate your transformation journey.
              </p>
          ...
          <div className="container ss-container">
            ...
            <div className="left-div-ss">
              ...
              <p className="left-head-para-ss">
                ...
                With over 20 years of experience, we provide flexible solutions
                aligned with client requirements. Whether augmenting internal
                teams or full outsourcing, our aim is incident reduction.
                Proactive services and continuous improvement are our focus
                areas. At Decrecion Company, we ensure optimal SAP investment
                utilization. We're committed to empowering businesses for
                sustained growth and success. Choose Birchman for reliable and
                effective SAP support solutions
              </p>
              <button className="ss-button">Connect</button>
            </div>
          </div>
        </div>
      </section>

      <section id="wds" className="workday-support-section">
          ...
          <div className="container workday-container">
            <div className="left-div-workday">
              ...
              <p className="left-head-para-workday">
                ...
                solutions throughout the IT supply chain. Serving as your
                exclusive partner in this venture, Direccion streamlines all
                aspects, enabling you to boldly propel your transformation
                journey forward.
              </p>
          ...
          <div className="container os-container">
            ...
            <div className="left-div-os">
              ...
              <p className="left-head-para-os">
                ...
                integrated solutions across the IT supply chain. Serving as your
                exclusive partner in this venture, Direccion consolidates all
                aspects, empowering you to confidently accelerate your
                transformation journey with the backing of Oracle Support
              </p>
              <button className="os-button">Connect</button>
            </div>
          </div>
        </div>
      ...
      <section id="sfs" className="salesfore-section">
          ...
          <div className="container salesforce-container">
            <div className="left-div-salesforce">
              ...
              <p className="left-head-para-salesforce">
                ...
                specialized expertise to craft and execute integrated strategies
                across every facet of your sales ecosystem. As your dedicated
                and exclusive partner in this endeavor, we take charge of
                consolidating all aspects of support, providing you with the
                confidence and momentum needed to propel your sales objectives
                forward
              </p>
            ...
            <div className="right-div-salesforce">
              <img
                src="sfs.gif"
                alt="AI Image"
                className="image-ai-salesforce"
              />
            </div>
          </div>
        </div>
        <div className="container-divider-cloud">
          <div className="divider-cloud">
            <div className="line-cloud horizontal-cloud top-cloud" />
            <div className="square-cloud" />
            <div className="square-cloud second-cloud" />
            <div className="line-cloud horizontal-cloud bottom-cloud" />
          </div>
        </div>
      </section>
      <Speaktous />
