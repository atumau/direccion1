...
const technologyconsulting = () => {
  return (
    <>
      <section id="tc" className="techconsulting-section">
        <div className="tech-poster">
          ...
          <p className="tech-poster-para"data-aos="fade-down">
            ...
            pinpointing the precise technologies to tackle your most formidable
            business challenges—across all sectors. With their expertise,
            navigating the ever-shifting landscape of technology becomes not
            just manageable, but an opportunity for transformative growth.
          </p>
        </div>
          ...
          <div className="container tech-container">
            <div className="left-div-tech">
              ...
              <p className="left-head-para-tech"data-aos="fade-down">
                ...
                unlock the power of digital platforms, fostering seamless
                collaboration and delivering invaluable insights across every
                facet of the business process spectrum. From optimizing
                Manufacturing and Procurement to streamlining Human Resources
                and fortifying Core Finance, our tailored approach ensures
          ...
          <div className="container cs-container">
            ...
            <div className="left-div-cs">
              ...
              <p className="left-head-para-cs"data-aos="fade-down">
                ...
                business's unique challenges, ensuring targeted and effective
                defenses. As your trusted partner, we navigate the intricacies
                of cyber threats, empowering your organization to adapt and
                flourish securely. With Decreccion by your side, confidence in
                your digital resilience becomes a reality, fostering growth and
                innovation without compromise.
              </p>
              <button className="cs-button">Connect</button>
            </div>
          </div>
        </div>
      </section>
      <section id="as" className="advisory-section">
          ...
          <div className="container advisory-container">
            <div className="left-div-advisory">
              ...
              <p className="left-head-para-advisory"data-aos="fade-down">
                ...
                digital platforms, enabling seamless integration and providing
                invaluable insights across every aspect of operations. Whether
                optimizing manufacturing and procurement or fortifying core
                finance, our tailored approach ensures sustainable growth and
          ...
          <div className="container pci-container">
            ...
            <div className="left-div-pci">
              ...
              <p className="left-head-para-pci"data-aos="fade-down">
                ...
                practical experience. Our methodology is grounded in a deep
                comprehension of your organization's distinct challenges,
                guaranteeing precise and impactful strategies. As your dedicated
                ally, we adeptly navigate the complexities of process
                optimization, empowering your business to thrive and evolve
                securely. With Decression guiding your journey, confidence in
                your operational resilience is assured, fostering sustainable
                growth and innovation without compromise.
              </p>
              <button className="pci-button">Connect</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="mso" className="managed-services-section">
          ...
          <div className="container mso-container">
            <div className="left-div-mso">
              ...
              <p className="left-head-para-mso"data-aos="fade-down">
                ...
                partners, companies can access expert knowledge and resources
                while maintaining flexibility and scalability. This strategic
                approach enables organizations to adapt swiftly to market
                changes, enhance efficiency, and drive sustainable growth.
                Whether it's IT infrastructure management, customer support, or
                back-office processes, leveraging managed services and
                outsourcing solutions can significantly bolster a company's
                competitive edge in today's dynamic business landscape
              </p>
        ...
        <div className="custom-shape-divider-bottom-1713512226">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
          ...
          <div className="container tce-container">
            ...
            <div className="left-div-tce">
              ...
              <p className="left-head-para-tce"data-aos="fade-down">
                ...
                and fostering a culture of continuous learning, Decreccion
                empowers its workforce to reach their full potential. Tailored
                training initiatives equip employees with cutting-edge skills
                and knowledge, ensuring they remain industry leaders. These
                efforts are bolstered by Decreccion's Centers of Excellence,
                dedicated hubs where innovation thrives and breakthroughs
                emerge. By investing in its people and cultivating centers of
                excellence, Decreccion not only ensures its own success but also
                drives industry advancement
              </p>
              <button className="tce-button">Know more</button>
            </div>
          </div>
        </div>
      </section>
